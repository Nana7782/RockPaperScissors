  ...
  const playGame = (): void => {
    ...
    userOptions.forEach((option: Element) => {
      option.addEventListener("click", function (this: HTMLElement) {
        ...
        const countMoves = document.querySelector(".countMoves") as HTMLElement;
        moves++;
...
const resultCounter = (): void => {
  ...
  const computerCounter = document.querySelector(".computerResult") as HTMLElement;
...
const gameOver = (userOptions: NodeListOf<Element>): void => {
